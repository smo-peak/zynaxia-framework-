...
from src.licensing.kill_switch_controller import KillSwitchController, KillSwitchError, KillSwitchState
...
def kill_switch_controller(audit_emitter, blockchain_anchor):
    ...
    return KillSwitchController(audit_emitter=audit_emitter, blockchain_anchor=blockchain_anchor)
...
class TestLIC076Compliance:
    ...
    @pytest.mark.asyncio
    async def test_LIC_076_deactivation_anchored_blockchain(
        self, kill_switch_controller, sample_license, blockchain_anchor
    ):
