...
from src.licensing.module_gate import ModuleGate, ModuleAccessDeniedError
...
def module_gate(license_cache, audit_emitter):
    ...
    return ModuleGate(license_cache=license_cache, audit_emitter=audit_emitter)
...
class TestLIC081Compliance:
    ...
    def test_LIC_081_check_module_access_unlicensed_module_returns_false(
        self, module_gate, license_cache, sample_license
    ):
