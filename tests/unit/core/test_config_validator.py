...
class TestConfigValidator:
    ...
    def test_valid_config_passes(self):
        ...
        config = {
            ...
            "roles": [
                {"id": "platform_admin", "level": 0, "permissions": ["platform:*"]},
                {"id": "site_operator", "level": 3, "permissions": ["site:events:read", "site:events:write"]},
            ],
            "license": {"duration_days": 365},
        }
    ...
    def test_wildcard_blocked_for_non_platform(self):
        ...
        config = {"roles": [{"id": "site_admin", "level": 3, "permissions": ["site:*"]}]}
    ...
    def test_wildcard_allowed_for_platform(self):
        ...
        config = {"roles": [{"id": "platform_admin", "level": 0, "permissions": ["platform:*", "system:*"]}]}
    ...
    def test_role_cannot_have_higher_level_permissions(self):
        ...
        config = {
            ...
            "roles": [{"id": "site_admin", "level": 3, "permissions": ["organization:manage", "site:events:read"]}],
        }
    ...
    def test_license_duration_max_366_days(self):
        ...
        config = {"license": {"duration_days": 400}}
    ...
    def test_license_duration_366_days_allowed(self):
        ...
        config = {"license": {"duration_days": 366}}
    ...
    def test_validate_rule_specific(self):
        ...
        config = {"roles": [{"id": "invalid_role", "level": 2, "permissions": ["role:*"]}]}
    ...
    def test_multiple_errors_collected(self):
        ...
        config = {
            "roles": [{"id": "bad_role", "level": 2, "permissions": ["role:*"]}],
            "license": {"duration_days": 500},
        }
