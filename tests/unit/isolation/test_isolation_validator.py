...
class TestIsolationValidator:
    ...
    def test_cross_level_isolation_child_blocked(self):
        ...
        result = self.validator.test_cross_level_isolation(child_tenant, 3, parent_tenant, 2)
    ...
    def test_validate_all_handles_errors(self):
        ...
        tenants = [{"id": "invalid-uuid", "level": 3}, {"id": "660e8400-e29b-41d4-a716-446655440001", "level": 3}]
    ...
    def test_validation_result_structure(self):
        ...
        result_with_failures = ValidationResult(passed=False, tests_run=3, failures=["error1", "error2"])
