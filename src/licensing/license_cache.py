...
class LicenseCache(ILicenseCache):
    ...
    def set(self, site_id: str, license: License) -> None:
        ...
        try:
            ...
            cached_license = CachedLicense(
                license=license, cached_at=now, encrypted_data=encrypted_data, hash_value=hash_value
            )
    ...
    def _verify_cache_integrity(self, cached_license: CachedLicense) -> bool:
        ...
        try:
            # Recalculer hash
            expected_hash = self._compute_cache_hash(cached_license.license, cached_license.cached_at)
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        critical_offline = sum(1 for site_id in self._cache.keys() if self.is_cloud_offline_critical(site_id))
