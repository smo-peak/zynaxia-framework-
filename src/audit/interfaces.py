...
class IAuditQuery(ABC):
    ...
    @abstractmethod
    async def get_critical_events(self, tenant_id: str, hours_back: int = 24) -> List[AuditEvent]:
        """
    ...
    @abstractmethod
    async def search_events(self, tenant_id: str, query: Dict[str, Any]) -> List[AuditEvent]:
        """
